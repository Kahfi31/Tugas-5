...
public class Halaman_Penukaran_Periode extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_halaman_penukaran_periode);
    ...
    public void reedem(View view) {
        Intent reedem = new Intent(Halaman_Penukaran_Periode.this, Halaman_KTP.class);
        startActivity(reedem);
    }

    public void kembali(View view) {
        Intent kembali = new Intent(Halaman_Penukaran_Periode.this, Halaman_Utama.class);
